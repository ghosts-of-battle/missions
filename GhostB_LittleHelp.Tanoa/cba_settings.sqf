...
// ACE Logistics
force force ace_cargo_enable = false;
...
force force ace_medical_allowLitterCreation = false;
...
force force ace_medical_litterSimulationDetail = 0;
...
// ADV - ACE CPR
force force adv_aceCPR_addTime = 40;
force force adv_aceCPR_AED_stationType = """Land_Defibrillator_F""";
force force adv_aceCPR_chance_0 = 6;
force force adv_aceCPR_chance_1 = 52;
force force adv_aceCPR_chance_2 = 78;
...
force force adv_aceSplint_reopenChance = 0;
...
force force MRH_MilsimTools_Delete_disconnected_body = true;
...
force force MRH_MilsimTools_Map_ZoomRatio = 0.3;
...
force MRH_MilsimTools_Heli_CustomCondition = "(isFormationLeader player) && ([player, 'ACRE_PRC117F'] call acre_api_fnc_hasKindOfRadio)";
...
force MRH_MilsimTools_FireSupport_NumberOfSuppliesDrops = "16";
force MRH_MilsimTools_FireSupport_Supplies_ConditionIsFormLeader = true;
force MRH_MilsimTools_FireSupport_Supplies_CustomCondition = "(isFormationLeader player) && ([player, 'ACRE_PRC117F'] call acre_api_fnc_hasKindOfRadio)";
...
force force MRH_SAT_MaxSatAltitude = 300;
...
force BLU_F = true;
force BLU_F_CTRG = true;
force BLU_F_CTRG_T = true;
force BLU_G_F = true;
force BLU_GEN_F = true;
force BLU_ION_F = true;
force BLU_T_F = true;
force CIV_F = true;
...
force IND_F = true;
force IND_G_F = true;
force IND_MDF_F = true;
force IND_MPD_F = true;
force min_rf = true;
force min_rf_desert = true;
force min_rf_winter = true;
force OPF_A_F = true;
force OPF_F = true;
force OPF_G_F = true;
force OPF_T_F = true;
