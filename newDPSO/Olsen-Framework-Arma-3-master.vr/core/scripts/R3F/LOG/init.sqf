...
#include "R3F_LOG_ENABLE.h"
	...
	call compile preprocessFile format ["core\scripts\R3F\LOG\%1_strings_lang.sqf", R3F_LOG_CFG_language];
	...
	} forEach (R3F_LOG_CFG_can_be_moved_by_player + R3F_LOG_classes_objets_transportables);
	...
	if (isServer) then
	{
		...
		execVM "core\scripts\R3F\LOG\surveiller_objets_a_proteger.sqf";
	};
	...
	call compile preprocessFile "core\scripts\R3F\LOG\fonctions_generales\lib_geometrie_3D.sqf";
	...
	R3F_LOG_FNCT_determiner_fonctionnalites_logistique = compile preprocessFile "core\scripts\R3F\LOG\fonctions_generales\determiner_fonctionnalites_logistique.sqf";

	R3F_LOG_FNCT_calculer_chargement_vehicule = compile preprocessFile "core\scripts\R3F\LOG\transporteur\calculer_chargement_vehicule.sqf";
	R3F_LOG_FNCT_transporteur_charger_auto = compile preprocessFile "core\scripts\R3F\LOG\transporteur\charger_auto.sqf";
	...
	if !(isDedicated) then
	{
		...
		call compile preprocessFile "core\scripts\R3F\LOG\fonctions_generales\lib_visualisation_objet.sqf";

		R3F_LOG_FNCT_objet_relacher = compile preprocessFile "core\scripts\R3F\LOG\objet_deplacable\relacher.sqf";
		R3F_LOG_FNCT_objet_deplacer = compile preprocessFile "core\scripts\R3F\LOG\objet_deplacable\deplacer.sqf";

		R3F_LOG_FNCT_heliporteur_heliporter = compile preprocessFile "core\scripts\R3F\LOG\heliporteur\heliporter.sqf";
		R3F_LOG_FNCT_heliporteur_larguer = compile preprocessFile "core\scripts\R3F\LOG\heliporteur\larguer.sqf";
		R3F_LOG_FNCT_heliporteur_init = compile preprocessFile "core\scripts\R3F\LOG\heliporteur\heliporteur_init.sqf";

		R3F_LOG_FNCT_remorqueur_detacher = compile preprocessFile "core\scripts\R3F\LOG\remorqueur\detacher.sqf";
		R3F_LOG_FNCT_remorqueur_remorquer_deplace = compile preprocessFile "core\scripts\R3F\LOG\remorqueur\remorquer_deplace.sqf";
		R3F_LOG_FNCT_remorqueur_remorquer_direct = compile preprocessFile "core\scripts\R3F\LOG\remorqueur\remorquer_direct.sqf";
		R3F_LOG_FNCT_remorqueur_init = compile preprocessFile "core\scripts\R3F\LOG\remorqueur\remorqueur_init.sqf";

		R3F_LOG_FNCT_transporteur_charger_deplace = compile preprocessFile "core\scripts\R3F\LOG\transporteur\charger_deplace.sqf";
		R3F_LOG_FNCT_transporteur_charger_selection = compile preprocessFile "core\scripts\R3F\LOG\transporteur\charger_selection.sqf";
		R3F_LOG_FNCT_transporteur_decharger = compile preprocessFile "core\scripts\R3F\LOG\transporteur\decharger.sqf";
		R3F_LOG_FNCT_transporteur_selectionner_objet = compile preprocessFile "core\scripts\R3F\LOG\transporteur\selectionner_objet.sqf";
		R3F_LOG_FNCT_transporteur_voir_contenu_vehicule = compile preprocessFile "core\scripts\R3F\LOG\transporteur\voir_contenu_vehicule.sqf";
		R3F_LOG_FNCT_transporteur_init = compile preprocessFile "core\scripts\R3F\LOG\transporteur\transporteur_init.sqf";

		R3F_LOG_FNCT_usine_remplir_liste_objets = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\remplir_liste_objets.sqf";
		R3F_LOG_FNCT_usine_creer_objet = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\creer_objet.sqf";
		R3F_LOG_FNCT_usine_ouvrir_usine = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\ouvrir_usine.sqf";
		R3F_LOG_FNCT_usine_init = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\usine_init.sqf";
		R3F_LOG_FNCT_usine_revendre_deplace = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\revendre_deplace.sqf";
		R3F_LOG_FNCT_usine_revendre_selection = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\revendre_selection.sqf";
		R3F_LOG_FNCT_usine_revendre_direct = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\revendre_direct.sqf";
		R3F_LOG_FNCT_recuperer_liste_cfgVehicles_par_categories = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\recuperer_liste_cfgVehicles_par_categories.sqf";
		R3F_LOG_FNCT_determiner_cout_creation = compile preprocessFile "core\scripts\R3F\LOG\usine_creation\determiner_cout_creation.sqf";

		R3F_LOG_FNCT_objet_init = compile preprocessFile "core\scripts\R3F\LOG\objet_commun\objet_init.sqf";
		R3F_LOG_FNCT_objet_est_verrouille = compile preprocessFile "core\scripts\R3F\LOG\objet_commun\objet_est_verrouille.sqf";
		R3F_LOG_FNCT_deverrouiller_objet = compile preprocessFile "core\scripts\R3F\LOG\objet_commun\deverrouiller_objet.sqf";
		R3F_LOG_FNCT_definir_proprietaire_verrou = compile preprocessFile "core\scripts\R3F\LOG\objet_commun\definir_proprietaire_verrou.sqf";

		R3F_LOG_FNCT_formater_fonctionnalites_logistique = compile preprocessFile "core\scripts\R3F\LOG\fonctions_generales\formater_fonctionnalites_logistique.sqf";
		R3F_LOG_FNCT_formater_nombre_entier_milliers = compile preprocessFile "core\scripts\R3F\LOG\fonctions_generales\formater_nombre_entier_milliers.sqf";
		...
		execVM "core\scripts\R3F\LOG\surveiller_conditions_actions_menu.sqf";

		/* Auto-d?tection permanente des objets sur le jeu */
		execVM "core\scripts\R3F\LOG\surveiller_nouveaux_objets.sqf";
		 ...
		 */
		execVM "core\scripts\R3F\LOG\systeme_protection_blessures.sqf";
	};
