 ...
 *
 * @usage nul = [my_object] execVM "core\scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "spawn_pos"] execVM "core\scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "cargo_pos"] execVM "core\scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "<marker name>"] execVM "core\scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 *
