 ...
 *
 * @usage execute the following line in the BIS' DPSO_debug console or the init line of the player
 * @usage nul = [] execVM "core\scripts\R3F\LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 *
 * @usage to not dump the comments after the class names, set the optional param 0 to false
 * @usage nul = [false] execVM "core\scripts\R3F\LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 *
 * @usage to dump all categories, including empty ones, set param 1 to true
 * @usage nul = [true, true] execVM "core\scripts\R3F\LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 */
