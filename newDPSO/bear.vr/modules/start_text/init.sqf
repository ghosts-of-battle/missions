["Start Text", "1.0", "Displays animated text on mission start.", "Olsen &amp; Starfox64"] call FNC_RegisterModule;
...
if (!isDedicated) then {
	...
	#include "settings.sqf"
		...
		if (!isNil "_startTextArray") then { // Check that _startTextArray isn't null!
