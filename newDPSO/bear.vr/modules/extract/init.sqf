["Extract", "1.0", "When called, the module will spawn an AI controlled vehicle and will wait until all players are mounted before extracting.", "Starfox64"] call FNC_RegisterModule;
