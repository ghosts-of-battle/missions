...
// To manually track an asset use [asset, name, team] call FNC_TrackAsset; in its init field, the team has to correspond with the teams declared in customisation\settings.sqf.

//Example:
//[this, "UNICEF Hemmit", "USMC"] call FNC_TrackAsset;
//[this, "Entrenched DShK", "VDV"] call FNC_TrackAsset;

// To manually track all units inside a marker use [marker, team] call FNC_TrackAssetArea; the team has to correspond with the teams declared in customisation\settings.sqf.
