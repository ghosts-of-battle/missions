...
// ----------------------------------------------------------------------
	...
	// HEADGEAR
	_unit addHeadgear (selectRandom (OPEX_friendly_commonHelmets + OPEX_friendly_bandanas));
...
// ----------------------------------------------------------------------
	...
	// NVG
	if (random 1 > 0.9) then {_unit linkItem (selectRandom OPEX_friendly_NVGs)} else {_unit addItemToBackpack (selectRandom OPEX_friendly_NVGs)};
...
// ----------------------------------------------------------------------
	...
	if (count OPEX_wireCutters > 0) then {_unit addItemToBackpack (selectRandom OPEX_wireCutters)};
	if (count OPEX_wireCutters > 0) then {_unit addItemToBackpack (selectRandom OPEX_wireCutters)};
	if (count OPEX_wireCutters > 0) then {_unit addItemToBackpack (selectRandom OPEX_wireCutters)};
