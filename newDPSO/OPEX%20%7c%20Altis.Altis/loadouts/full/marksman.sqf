...
// ----------------------------------------------------------------------
	...
	// HEADGEAR
	_unit addHeadgear (selectRandom (OPEX_friendly_commonHelmets + OPEX_friendly_hats + OPEX_friendly_beanies + OPEX_friendly_caps + OPEX_friendly_bandanas));
...
// ----------------------------------------------------------------------
	...
	// NVG
	if ((random 1 > 0.8) && (OPEX_sunHeight < 0)) then {_unit linkItem (selectRandom OPEX_friendly_NVGs)} else {_unit addItemToBackpack (selectRandom OPEX_friendly_NVGs)};
