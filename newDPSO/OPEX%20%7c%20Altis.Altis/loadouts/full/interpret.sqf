...
// ----------------------------------------------------------------------
	...
	if (count _compatibleRifleFlashlights > 0) then {private _rifleFlashlight = selectRandom _compatibleRifleFlashlights; if (random 1 > 0.5) then {_unit addPrimaryWeaponItem _rifleFlashlight} else {_unit addItemToVest _rifleFlashlight}};
...
// ----------------------------------------------------------------------
	...
	for "_i" from 1 to 1 do {_unit addItemToBackpack (selectRandom OPEX_medical_medikits)};
...
// ----------------------------------------------------------------------
	...
	_unit setUnitTrait ["interpret", true, true];