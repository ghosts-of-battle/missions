...
// =======================================================================================================================
	...
	// UNITS
	OPEX_enemy_rifleman = "cfp_o_is_rifleman";
	OPEX_enemy_teamLeader = "cfp_o_is_team_leader";
	OPEX_enemy_grenadier = "cfp_o_is_grenadier";
	OPEX_enemy_MG = "cfp_o_is_machinegunner";
	OPEX_enemy_AT = "cfp_o_is_at";
	OPEX_enemy_AA = "cfp_o_is_irregular";
	OPEX_enemy_marksman = "cfp_o_is_sniper";
	OPEX_enemy_crewman = "cfp_o_is_crewman";
	...
	// VEHICLES
	OPEX_enemy_transportTrucks = ["cfp_o_is_Ural"];
	OPEX_enemy_fuelTrucks = ["I_G_VAN_01_fuel_F", "O_G_VAN_01_fuel_F", "C_VAN_01_fuel_F", "C_truck_02_fuel_F"];
	OPEX_enemy_transportCars = ["cfp_o_is_LR_Unarmed", "cfp_o_is_offroad", "cfp_o_is_offroad", "cfp_o_is_offroad_flag", "cfp_o_is_UAZ_Unarmed", "cfp_o_is_UAZ_Open"];
	OPEX_enemy_combatCars = ["cfp_o_is_hmmwv_dshkm", "cfp_o_is_jeep_at", "cfp_o_is_jeep_lmg", "cfp_o_is_LR_M2", "cfp_o_is_offroad_at", "cfp_o_is_offroad_M2", "cfp_o_is_offroad_M2_flag", "cfp_o_is_pickup_PK", "cfp_o_is_pickup_PK_flag"];
	...
	OPEX_enemy_MGstatics = ["cfp_o_is_DSHKM", "cfp_o_is_KORD_high", "cfp_o_is_M2Static"];
	OPEX_enemy_GLstatics = ["cfp_o_is_AGS"];
	OPEX_enemy_ATstatics = ["cfp_o_is_SPG9", "cfp_o_is_TOW"];
	OPEX_enemy_AAstatics = ["cfp_o_is_Metis"];
	OPEX_enemy_mortarStatics = ["cfp_o_is_2b14_82mm", "cfp_o_is_M252"];
	...
	// UNIFORMS
	OPEX_enemy_commonUniforms = ["U_BG_Guerilla2_3", "U_BG_Guerilla2_1", "SP_0000_Standard_BattleDressUniform_Black", "SP_0000_Standard_BattleDressUniform_Black", "SP_0000_Standard_BattleDressUniform_Black", "SP_0000_Standard_BattleDressUniform_Black", "SP_0000_Standard_BattleDressUniform_Black", "SP_0000_Standard_BattleDressUniform_Green", "CFP_U_BattleDressUniform_M81light", "CFP_U_Crye_IDF", "CFP_U_Crye_M81", "SP_0000_Standard_FieldUniform_Black", "SP_0000_Standard_FieldUniform_Black", "SP_0000_Standard_FieldUniform_Black", "SP_0000_Standard_FieldUniform_Black", "SP_0000_Standard_FieldUniform_Black", "SP_0000_Standard_FieldUniform_Green", "CFP_U_FieldUniform_M81light", "CFP_U_FieldUniform_tigerstripe2", "CFP_U_FieldUniform_marpatugandadark", "SP_0000_Standard_FieldUniform_Black_SS", "SP_0000_Standard_FieldUniform_Black_SS", "CFP_FieldUniform_blackacu_SS", "SP_0000_Standard_FieldUniform_Green_SS", "CFP_FieldUniform_tanblack_SS", "CFP_U_KhetPartug_Long_Black", "CFP_U_KhetPartug_Short_Black", "CFP_U_KhetPartug_Short_Black", "CFP_U_KhetPartug_Short_Black", "SP_0000_Standard_PulloverUniform_Black", "CUP_I_B_PMC_Unit_20", "CUP_I_B_PMC_Unit_17", "CUP_I_B_PMC_Unit_13", "CUP_I_B_PMC_Unit_15", "CUP_I_B_PMC_Unit_3", "CUP_I_B_PMC_Unit_24", "CUP_I_B_PMC_Unit_35", "CUP_U_O_SLA_Overalls_Tank"];
	...
	OPEX_enemy_headgears = ["H_Bandanna_gry", "H_Cap_blk", "H_ShemagOpen_tan", "H_Shemag_olive", "H_ShemagOpen_khk", "SP_BoonieHat_Black", "SP_Hood_Black", "SP_Hood_Green", "CFP_Lungee_Shemagh_Black", "SP_Shemagh_Black", "SP_Shemagh_Black", "SP_Shemagh_Black", "SP_Shemagh_CheckBlack", "SP_Shemagh_CheckGreen", "SP_Shemagh_Green", "CFP_Shemagh_Head_Black", "CFP_Shemagh_Head_M81", "CFP_Shemagh_Full_Black", "CFP_Shemagh_Full_Green", "CFP_Shemagh_Full_M81"];
	OPEX_enemy_officerHeadgears = ["SP_Shemagh_CheckRed", "CFP_Shemagh_Full_Red", "CFP_Shemagh_Head_Red"];

	// FACEGEAR
	OPEX_enemy_balaclavas = ["G_Balaclava_blk", "G_Balaclava_blk", "G_Balaclava_blk", "G_Balaclava_blk", "G_Balaclava_blk", "IS_Balaclava", "IS_Balaclava", "IS_Balaclava", "IS_Balaclava_logo1", "IS_Balaclava_logo1", "IS_Balaclava_logo1", "IS_Balaclava_logo1", "IS_Balaclava_logo1", "IS_Balaclava_logo2", "IS_Balaclava_logo2", "IS_Balaclava_logo2", "IS_Balaclava_logo2", "IS_Balaclava_logo2"];
	OPEX_enemy_scarfs = ["G_Bandanna_tan", "G_Bandanna_khk", "G_Bandanna_blk", "G_Bandanna_blk", "G_Bandanna_blk", "G_Bandanna_oli", "CFP_Shemagh_Half_Black", "CFP_Shemagh_Half_Black", "CFP_Shemagh_Half_Black", "CFP_Shemagh_Half_Red", "CFP_Shemagh_Half_Tan", "CUP_FR_NeckScarf3", "CUP_FR_NeckScarf", "CUP_FR_NeckScarf5", "CUP_FR_NeckScarf2","CFP_Shemagh_Neck_Black","CFP_Shemagh_Neck_Black","CFP_Shemagh_Face_Red"];
