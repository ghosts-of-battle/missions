...
// =======================================================================================================================
	...
	// UNIFORMS
	OPEX_enemy_commonUniforms = ["CUP_U_CRYE_BLK_Full","CUP_U_CRYE_BLK_Full","CUP_U_CRYE_BLK_Full","CUP_U_CRYE_BLK_Full","CUP_U_CRYE_BLK_Full","CUP_U_CRYE_BLK_Roll","CUP_U_CRYE_BLK_Roll","CUP_U_CRYE_BLK_Roll","CUP_I_B_PMC_Unit_20","CUP_I_B_PMC_Unit_17","CUP_I_B_PMC_Unit_17","CUP_I_B_PMC_Unit_13","CUP_I_B_PMC_Unit_13","CUP_I_B_PMC_Unit_3","CUP_I_B_PMC_Unit_11","CUP_I_B_PMC_Unit_24","CUP_I_B_PMC_Unit_24","CUP_I_B_PMC_Unit_24","CUP_I_B_PMC_Unit_24","CUP_I_B_PMC_Unit_24","CUP_I_B_PMC_Unit_35"];
	...
	OPEX_enemy_headgears = ["H_Bandanna_gry","H_ShemagOpen_tan","H_Shemag_olive","H_Shemag_olive","CUP_H_PMC_Cap_Grey","CUP_H_PMC_Cap_Grey","CUP_H_PMC_Cap_Grey","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TK_Lungee","CUP_H_TKI_Lungee_01","CUP_H_TKI_Lungee_02","CUP_H_TKI_Lungee_03"];
	...
	OPEX_enemy_scarfs = ["G_Bandanna_blk","CUP_G_Scarf_Face_Blk","CUP_G_Scarf_Face_Blk","CUP_G_Scarf_Face_Blk","CUP_G_Scarf_Face_Grn","CUP_G_Scarf_Face_Red","CUP_FR_NeckScarf3","CUP_FR_NeckScarf3","CUP_FR_NeckScarf5"];
