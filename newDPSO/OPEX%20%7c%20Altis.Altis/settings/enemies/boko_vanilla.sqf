...
// =======================================================================================================================
	...
	if (395180 in (getDLCs 1)) then {OPEX_enemy_specialRifles = ["SMG_02_F"]} else {OPEX_enemy_specialRifles = ["hgun_PDW2000_F", "SMG_02_F"]};
	...
	// UNIFORMS
	OPEX_enemy_commonUniforms = ["U_IG_Guerilla1_1","U_IG_Guerilla2_1","U_IG_Guerilla2_3","U_IG_Guerilla3_1","U_IG_Guerilla3_2","U_IG_leader","U_BG_Guerilla1_1","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_BG_Guerilla3_1","U_BG_Guerilla3_2","U_BG_leader","U_OG_Guerilla1_1","U_OG_Guerilla2_1","U_OG_Guerilla2_3","U_OG_Guerilla3_1","U_OG_Guerilla3_2","U_OG_leader"];
	...
	OPEX_enemy_headgears = ["H_Bandanna_gry","H_Bandanna_gry","H_Bandanna_gry","H_Cap_blk","H_Cap_blk","H_Cap_blk","H_ShemagOpen_khk","H_ShemagOpen_tan","H_ShemagOpen_tan","H_Shemag_olive","H_Shemag_olive"];
	OPEX_enemy_officerHeadgears = OPEX_enemy_headgears;

	// FACEGEAR
	OPEX_enemy_balaclavas = ["G_Balaclava_blk"];
	OPEX_enemy_scarfs = ["G_Bandanna_blk"];
	OPEX_enemy_glasses = ["G_Squares","G_Spectacles"];
	OPEX_enemy_sunglasses = ["G_Squares_Tinted","G_Squares_Tinted","G_Squares_Tinted","G_Spectacles_Tinted","G_Aviator","G_Aviator","G_Bandanna_aviator","G_Bandanna_aviator"];
