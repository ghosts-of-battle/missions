...
_OPEX_friendly_modName = "vanilla"; // e.g.: "RHS"
...
// ENABLING FACTION
if (isServer) then {OPEX_friendly_factions = [[_OPEX_friendly_subFaction, _OPEX_friendly_modName]]; publicVariable "OPEX_friendly_factions"};
...
OPEX_friendly_rifleSilencers = ["muzzle_snds_H", "muzzle_snds_I", "muzzle_snds_M"];
...
OPEX_wireCutters = [];
OPEX_flashlights = [];
OPEX_constructions = ["Fortifications", "Structures_Fences", "Tents", "Market", "Signs", "Lamps", "Furniture", "Flag", "Misc", "Furniture"];
...
// BACKPACKS
OPEX_friendly_mediumBackpacks_woodland = ["B_AssaultPack_khk", "B_AssaultPack_blk", "B_AssaultPack_rgr", "B_Kitbag_mcamo", "B_Kitbag_rgr", "B_Carryall_green_F", "B_TacticalPack_mcamo", "B_TacticalPack_blk", "B_TacticalPack_oli", "B_TacticalPack_rgr"];
