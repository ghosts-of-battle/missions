		...
		class Controls
			{
				// TITLE PART
					...
					class OPEX_buySupplies_mainTitle: RscText
						{
							idc = 600;
							style = ST_LEFT;
							text = $STR_dialog_buySuppliesTitle;
				...
				// MAIN PART
					...
					class OPEX_buySupplies_mainBackground: RscFrame
						{
							idc = 601;
							x = 0.35 * safezoneW + safezoneX;
					...
					// Supplies
						...
						class OPEX_buySupplies_listTitleBackground: RscText
							{
								idc = 602;
								style = ST_LEFT;
								x = 0.35 * safezoneW + safezoneX;
						...
						class OPEX_buySupplies_listTitle: RscListNbox
							{
								idc = 603;
								x = 0.35 * safezoneW + safezoneX;
								y = 0.28 * safezoneH + safezoneY;
						...
						class OPEX_buySupplies_listContent: RscListNbox
							{
								idc = 604;
								x = 0.35 * safezoneW + safezoneX;
						...
						class OPEX_buySupplies_buyButton: RscButton
							{
								idc = 605;
								sizeEx = 0.035;
						...
						class OPEX_buySupplies_closeButton: RscButton
							{
								idc = 606;
								x = 0.35 * safezoneW + safezoneX;
