...
copyToClipboard format ["%1", [typeOf (((position player) nearEntities 3) select 0), (nearestBuilding player) worldToModel (getPosATL (((position player) nearEntities 3) select 0)), (getDir nearestBuilding player) - (getDir (((position player) nearEntities 3) select 0))]]
...
tpw_furniture_fnc_populate =
	...
	if (_bld getvariable ["tpw_furnished",0] == 0) then
		...
		switch _type do
			...
			case "Land_House_C_10_EP1":
				{
					_templates = [[["Land_Pallets_F",[-2.23682,1.15137,-4.18064],0],["Land_tires_EP1",[-1.87744,-0.663086,-4.18905],-234.178],["Land_WoodenTable_small_F",[-1.23779,-8.96582,-0.872208],-89.6424],["Land_TableSmall_01_F",[-0.242188,5.41406,-0.868187],-270.231],["Land_Workbench_01_F",[-1.57324,-9.13916,-4.20195],-180.01],["Land_Metal_wooden_rack_F",[0.351563,-5.72949,-4.19182],-271.196]]];
			...
			case "Land_House_C_11_EP1":
				{
					_templates = [[["CUP_lobby_table",[0.270508,-1.57813,-2.14987],0],["SmallTable",[7.6958,1.77686,0.971534],-90.3401],["Land_ChairPlastic_F",[6.84668,1.76465,0.970537],-359.899]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_C_5_EP1":
				{
					_templates = [[["SmallTable",[-0.598145,-4.71826,-0.803645],-270.038],["Land_ChairWood_F",[-1.1416,-4.77588,-0.814018],-260.712],["SmallTable",[4.08203,5.13818,-0.802156],-180.712]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_C_5_V2_EP1":
				{
					_templates = [[["SmallTable",[-4.39258,-4.93701,-1.36836],-90.7675],["Land_Chair_EP1",[-3.6626,-4.98096,-1.36836],-201.264]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_C_5_V3_EP1":
				{
					_templates = [[["SmallTable",[-0.581055,-4.85693,1.17207],-268.511],["CUP_conference_table_a",[-0.606445,-1.14258,-1.47294],-269.942],["Land_ChairWood_F",[-1.2002,-1.37695,-1.47394],-260.414],["CUP_stul_hospoda",[3.75586,1.60303,1.39877],0]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_A_Villa_EP1":
				{
					_templates = [[["Land_FlowerPot_01_Flower_F",[6.34521,-3.40186,-1.48683],-359.976],["Land_TablePlastic_01_F",[-4.17383,-3.6167,-1.4865],-226.879],["Land_Chair_EP1",[-3.72217,-5.06396,-1.48584],-266.523],["Land_ChairPlastic_F",[-5.15234,-4.10547,-1.48683],-334.143],["Land_WaterCooler_01_old_F",[0.647461,9.25977,-5.06934],-317.07],["Land_OfficeCabinet_01_F",[0.520508,15.5635,-1.48681],-46.0102],["SmallTable",[-7.51611,15.9922,-5.06864],0],["Computer",[7.33154,7.02588,-4.2439],-135.749],["CUP_Kitchenstove_Elec",[-2.45703,15.9316,-5.06866],0],["Land_TableBig_01_F",[-5.79102,12.8193,-5.06632],-360],["Land_TableBig_01_F",[-3.61279,12.812,-5.06813],-179.263],["Land_Basket_F",[-5.3042,12.6948,-5.06706],-359.972],["Land_CratesPlastic_F",[0.145996,10.272,-5.06831],-311.87],["Fort_Crate_wood",[9.20898,1.26025,-5.06866],-309.234],["Land_RattanTable_01_F",[9.42188,-2.39648,-1.48684],-314.899],["Land_Sacks_goods_F",[0.0961914,15.3901,-5.06868],-189.415],["Land_CratesShabby_F",[-9.21436,9.84326,-5.06849],-92.3959],["Land_WheelieBin_01_F",[-8.00049,9.75391,-5.0695],-182.196],["CUP_flower_02",[5.38623,-2.48096,-5.06848],0],["CUP_flower_02",[0.715332,12.2769,-1.50043],0],["CUP_flower_02",[10.7031,0.606934,-1.48584],0],["Land_Cabinet_EP1",[3.70605,-2.81787,-5.06858],-269.126],["Land_Cabinet_EP1",[2.26172,-2.8584,-5.06858],-269.126],["Land_Carpet_EP1",[-2.62988,4.0835,-5.13822],0],["Land_Carpet_EP1",[-2.7373,1.68848,-5.14342],0],["Land_Microwave_01_F",[-7.65869,16.0503,-4.26473],-0.00256166],["Land_Rug_01_Traditional_F",[-1.38281,11.2256,-1.48584],0],["Land_ChairWood_F",[8.1377,7.15674,-5.07104],-50.6331],["Land_TableDesk_F",[7.66406,6.75488,-5.0704],-46.9328],["Land_ChairPlastic_F",[-3.13574,-3.23779,-1.48683],-142.148],["Land_ChairPlastic_F",[-4.2583,-2.27539,-1.48682],-107.109],["Fridge_01_closed_F",[-3.20801,14.2427,-4.70808],-180.408],["Fridge_01_closed_F",[-3.57666,15.8608,-5.06729],-359.973],["Land_Sack_F",[-1.24023,15.8213,-5.06867],0],["OfficeTable_01_old_F",[-8.43408,13.4839,-1.48684],-181.223],["OfficeTable_01_old_F",[-2.12646,13.7773,-1.48684],-90.8427],["OfficeTable_01_old_F",[-1.39697,13.7788,-1.48684],-269.841],["Land_OfficeChair_01_F",[-0.437988,13.7134,-1.48591],-94.326],["Land_OfficeChair_01_F",[-3.17676,13.7754,-1.48683],-251.777],["Land_FlowerPot_01_Flower_F",[7.14697,8.02783,-5.06669],-359.832],["Land_RattanChair_01_F",[10.0903,-1.71484,-1.48684],-59.7975],["Land_RattanChair_01_F",[8.58008,-3.10156,-1.48684],-226.347],["Land_PenRed_F",[8.10645,6.43408,-4.24982],-212.649],["Land_File1_F",[8,6.53809,-4.25017],-57.0619],["Land_Bench_01_F",[-2.93896,1.63281,-5.06857],-269.468],["Land_Bench_01_F",[-2.97803,4.26709,-5.06857],-269.468],["Land_OfficeCabinet_02_F",[12.4204,6.56738,-5.07581],-88.6076],["Land_OfficeCabinet_02_F",[12.3618,8.28223,-5.07637],-88.6012],["Land_OfficeCabinet_02_F",[12.3984,7.41016,-5.07637],-88.6013],["Land_Carpet_EP1",[14.208,-2.62598,-5.14106],-88.6354]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_C_4_EP1":
				{
					_templates = [[["Land_CampingChair_V2_F",[0.927246,0.123047,-0.352528],-327.46],["Land_WoodenTable_small_F",[-0.195801,2.48291,-0.346365],-0.14216],["Land_Rug_01_F",[0.281738,2.4209,-0.350568],-89.5322],["Land_CampingChair_V1_F",[0.586914,2.5459,-0.334819],-72.1487],["Land_WoodenTable_large_F",[1.51367,-1.01563,-0.353297],-88.6224],["Land_ChairPlastic_F",[1.24951,-1.99316,-0.353767],-276.374],["Land_ChairPlastic_F",[2.12354,0.188965,-0.352784],-95.7962],["Land_ShelvesWooden_khaki_F",[5.8374,1.30371,-0.353796],-0.111]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_L_3_EP1":
				{
					_templates = [[["Land_TableSmall_01_F",[-3.79785,3.23389,-0.224091],91.2029]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_L_4_EP1":
				{
					_templates = [[["CUP_lobby_table",[4.04736,2.45459,-1.06319],-176.887]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_L_6_EP1":
				{
					_templates = [[["CUP_lobby_table",[-0.586426,-1.51416,-1.53996],-359.149]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_L_7_EP1":
				{
					_templates = [[["CUP_lobby_table",[-0.641602,2.85059,-0.262116],-90.0451]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_L_8_EP1":
				{
					_templates = [[["CUP_lobby_table",[-2.22314,4.76807,-1.11706],-91.2564]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_K_1_EP1":
				{
					_templates = [[["SmallTable",[1.88965,5.94629,1.56482],0]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			case "Land_House_K_5_EP1":
				{
					_templates = [[["SmallTable",[2.18848,1.95117,1.51737],0]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_K_8_EP1":
				{
					_templates = [[["Land_Chair_EP1",[0.0541992,3.15674,0.259033],-262.287],["Land_ChairWood_F",[-0.479492,3.63867,3.35753],-258.946],["SmallTable",[0.0351563,3.92334,0.258025],0],["CUP_table_drawer",[0.356934,3.72363,3.35852],-267.959],["Land_Table_EP1",[1.9248,1.05322,-2.58373],-181.404]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_K_6_EP1":
				{
					_templates = [[["CUP_lobby_table",[-0.677734,3.33008,1.47137],-87.3709],["SmallTable",[-0.725098,4.80273,4.42],-89.0151],["Land_ChairWood_F",[-0.217773,4.75684,4.45066],-82.3505],["Land_ChairPlastic_F",[1.3501,-1.45654,-1.40654],-68.3954],["Land_WoodenTable_small_F",[1.625,-2.55566,-1.60848],-88.5206]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_K_3_EP1":
				{
					_templates = [[["Land_Rug_01_Traditional_F",[-1.04785,-2.41064,-0.791754],-91.576],["CUP_lobby_table",[-1.0332,-2.32471,-0.791754],0]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "and_House_K_7_EP1":
				{
					_templates = [[["Land_Rug_01_F",[-2.84863,1.81836,-0.219809],-89.8542],["CUP_lobby_table",[-2.9126,1.39453,-0.209116],0]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_House_K_2_basehide_EP1":
				{
					_templates = [[["Land_WoodenTable_small_F",[2.2124,5.64551,1.39865],-269.508],["Land_RattanChair_01_F",[2.25244,4.73877,1.39872],-172.696]]];
					_items = selectRandom _templates;
					_bld setvariable ["tpw_furnished",1];
					_bld setvariable ["tpw_furniture",_items];
				};
			...
			case "Land_i_Stone_HouseBig_V1_F":
				{
				_templates = [[["Land_Ground_sheet_folded_F",[0.4646,-0.281738,-1.65202],-138.81],["Land_Sleeping_bag_blue_F",[1.32336,-0.265869,-1.61729],180.337],["Land_Sleeping_bag_brown_folded_F",[0.178345,-0.943359,-1.62157],-51.8027],["Land_ChairPlastic_F",[1.34998,3.1167,1.21651],-86.1175],["Land_CampingTable_small_F",[0.171631,3.22949,1.21909],181.216],["Land_CampingChair_V1_F",[-0.0255127,2.10889,1.21959],165.395],["Land_ShelvesWooden_F",[-1.81042,0.352539,1.21544],181.433],["Land_Pillow_camouflage_F",[1.63269,-1.09668,-1.64397],-102.449]]];
				_items = selectRandom _templates;
				_bld setvariable ["tpw_furnished",1];
				_bld setvariable ["tpw_furniture",_items];
				};
			case "Land_i_Stone_Shed_V1_F":
				{
				_templates = [[["Land_TablePlastic_01_F",[-3.30518,1.10876,-0.102951],-89.1292],["Land_Bucket_F",[-0.113525,1.37769,-0.102921],-211.712],["Land_ChairPlastic_F",[-2.17969,0.806763,-0.102936],-193.006],["Land_ChairPlastic_F",[-3.44971,3.2738,-0.102936],-4.49753],["Land_Sleeping_bag_F",[2.45093,3.26416,-0.102356],-3.10698],["Land_Rug_01_Traditional_F",[1.7937,1.22632,-0.124161],90.2358],["Land_Ground_sheet_folded_blue_F",[1.48657,3.94702,-0.102936],-153.064]]];
				_items = selectRandom _templates;
				_bld setvariable ["tpw_furnished",1];
				_bld setvariable ["tpw_furniture",_items];
				};
			case "Land_i_Stone_HouseSmall_V1_F":
				{
				_templates = [[["Land_WoodenTable_large_F",[-5.05737,2.16357,-0.631149],91.2694],["Land_Basket_F",[3.74268,4.3584,-0.601547],183.312],["Land_Sacks_goods_F",[-0.081665,-0.139648,-0.62793],84.5884],["Land_Bench_F",[-5.48682,-0.726807,-0.652954],-89.4193],["Land_Sack_F",[1.44275,3.32349,-0.613663],96.3961],["Land_ChairPlastic_F",[-5.50574,1.22461,-0.642197],82.3208],["Land_ChairPlastic_F",[-3.34729,2.10229,-0.631012],178.464],["Land_ChairPlastic_F",[-4.83374,3.15137,-0.619675],-112.568],["Land_Rack_F",[0.277466,3.79883,-0.609634],179.054],["Land_TableSmall_01_F",[5.02112,-0.647949,-0.599533],-90.1384],["Land_WoodenBed_01_F",[8.11218,2.1167,-0.592361],-89.3705],["Land_ShelvesWooden_F",[-8.26453,4.73291,-0.604233],91.5643],["Land_ShelvesWooden_F",[8.34949,-0.706055,-0.592361],88.9201],["Land_WoodenTable_small_F",[3.80396,4.50879,-0.599762],90.335],["Land_Rug_01_Traditional_F",[3.71594,1.34692,-0.636612],-89.4506],["Land_RattanChair_01_F",[5.10596,4.60156,-0.598038],-13.9449]]];
				_items = selectRandom _templates;
				_bld setvariable ["tpw_furnished",1];
				_bld setvariable ["tpw_furniture",_items];
				};
	...
	_tables =
		[
			"OfficeTable_01_old_F", "OfficeTable_01_new_F",
			"Land_CampingTable_F", "Land_CampingTable_small_F", "Land_CampingTable_white_F", "Land_CampingTable_small_white_F", "Land_TablePlastic_01_F",
			"Land_WoodenTable_small_F", "Land_WoodenTable_large_F", "Land_WoodenTable_02_large_F",
			"Land_RattanTable_01_F",
			"Land_TableBig_01_F", "Land_TableSmall_01_F",
			"CUP_lobby_table", "CUP_table_drawer", "CUP_stul_hospoda",
			"SmallTable",
			"Land_Table_EP1"
		];

	// Furnish house if list is assigned and no people inside
	if (_bld getvariable "tpw_furnished" == 1 && {count (_bld nearEntities ["Man", 20]) == 0}) then
		{
				...
				if (random 1 > 0.25) then
					{
						...
						_object =  createsimpleobject [_item,[0,0,0]];
						_object setposatl _pos;
						_object setdir (_dir - _angle);
						...
						if (_item in _tables) then
						{
							_intel = _object call Gemini_fnc_intel;
							if (!isNil "_intel") then {_spawned append [_intel]};
						};
					};
			} count _items;
...
waitUntil {count OPEX_playingPlayers > 0};
private ["_blds","_item","_bld"];
while {true} do
	{
		if (count OPEX_playingPlayers > 0) then
			{
				// SELECTING A PLAYER
				private ["_player"];
				_player = selectRandom OPEX_playingPlayers;

				// Scan for houses to furnish
				if (tpw_furniture_active && {_player == vehicle _player} && {_player distance tpw_furniture_lastpos > (tpw_furniture_radius / 2) }) then
					{
						tpw_furniture_lastpos = position _player;
						_blds = _player nearObjects ["House",tpw_furniture_radius];
						{0 = [_x] spawn tpw_furniture_fnc_populate} count _blds;

						// Delete furniture from distant houses
						for "_i" from 0 to count tpw_furniture_houses - 1 do
							{
							_bld = tpw_furniture_houses select _i;
							if (_bld distance _player > tpw_furniture_radius) then
								{
									{
									deletevehicle _x;
									sleep 0.05;
