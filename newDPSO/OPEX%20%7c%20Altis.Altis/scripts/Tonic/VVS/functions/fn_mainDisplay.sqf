...
if(isNil "VVS_Cfg") then{_mode = (localize "STR_vvs_all");} else {_mode = VVS_Cfg};
...
{
	_checkBox ctrlSetText localize "STR_Yes";
	_checkBox ctrlSetTextColor [0,1,0,1];
}
	else
{
	_checkBox ctrlSetText localize "STR_No";
...
if(_mode == "All") then
{
	...
	} foreach [(localize "STR_vvs_all"), (localize "STR_vvs_car"), (localize "STR_vvs_air"), (localize "STR_vvs_ship"), (localize "STR_vvs_armored"), (localize "STR_vvs_autonomous"), (localize "STR_vvs_support")];
