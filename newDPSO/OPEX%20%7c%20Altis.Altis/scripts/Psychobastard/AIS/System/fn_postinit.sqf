...
[
	localize "STR_AIS_action_firstAid",
	player,
	1.5,
...
[
	localize "STR_AIS_action_stabilize",
	player,
	1.5,
...
// Gemni: disabling this action for the moment because animation is buggy - waiting for a script update from Psychobastard
/*
[
	localize "STR_AIS_action_carry",
	player,
	0,
...
[
	localize "STR_AIS_action_unload",
	player,
	4,
