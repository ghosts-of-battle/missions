...
(
	...
	{_noDrag} &&
	{_noDraging} &&
	(((uniformItems player) find OPEX_medical_firstAidKit > -1) || ((vestItems player) find OPEX_medical_firstAidKit > -1) || ((backpackItems player) find OPEX_medical_firstAidKit > -1) || ((uniformItems player) find "Medikit" > -1) || ((vestItems player) find "Medikit" > -1) || ((backpackItems player) find "Medikit" > -1))
