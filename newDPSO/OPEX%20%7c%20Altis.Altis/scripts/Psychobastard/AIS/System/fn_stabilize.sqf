...
[_healer, _injured, "stabilize"] call AIS_Effects_fnc_medEquip;
...
[
    localize "STR_AIS_action_stabilizing", 
    _duration,
    {
    ...
    [_injured, _healer],
	{
		...
		if (!alive _injured) then {["STR_AIS_dead"] call AIS_Core_fnc_dynamicText};
	},
