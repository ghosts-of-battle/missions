...
_is_able_to_do = switch (AIS_MEDICAL_EDUCATION) do
{
	...
	case (1) : {((uniformItems player) find OPEX_medical_defibrillator > -1) || ((vestItems player) find OPEX_medical_defibrillator > -1) || ((backpackItems player) find OPEX_medical_defibrillator > -1)};
