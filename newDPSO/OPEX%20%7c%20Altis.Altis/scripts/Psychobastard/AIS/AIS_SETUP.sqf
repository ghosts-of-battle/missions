...
AIS_AI_HELP_RADIUS 			= 	150; 			// Number, Radius in metres. Units in this radius will help to revive if no group member is able to revive. Max value is 200 metres.
...
AIS_IMPACT_EFFECTS 			= 	true; 			// Set to true to enable impact effects. (simple simulation of supressing effects)
