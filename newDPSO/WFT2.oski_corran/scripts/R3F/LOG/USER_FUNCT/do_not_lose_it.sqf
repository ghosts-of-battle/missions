 ...
 * 
 * @usage nul = [my_object] execVM "scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "spawn_pos"] execVM "scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "cargo_pos"] execVM "scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * @usage nul = [my_object, "<marker name>"] execVM "scripts\R3F\LOG\USER_FUNCT\do_not_lose_it.sqf";
 * 
