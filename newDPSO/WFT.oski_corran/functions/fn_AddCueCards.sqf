...
_cueCardsData = [
	...
	[
		"z\dpsov2\addons\Media\images\Cue Cards\casevac_request_CA.paa",
		"CASEVAC Request Card"
	],

	//	1 - Contact Report Card
	[
		"z\dpsov2\addons\Media\images\Cue Cards\contact_card_CA.paa",
		"Contact Report Card"
	],

	// 	2 - FAC 5-Liner Request Card
	[
		"z\dpsov2\addons\Media\images\Cue Cards\fac_5_liner_request_CA.paa",
		"FAC 5-Liner Request Card"
	],

	// 	3 - Fire Control Orders Card
	[
		"z\dpsov2\addons\Media\images\Cue Cards\fire_control_orders_CA.paa",
		"Fire Control Orders Card"
	],

	// 	4 - Reorg (GASCARD) Card
	[
		"z\dpsov2\addons\Media\images\Cue Cards\reorg_gascard_CA.paa",
		"Reorg (GASCARD) Card"
	]
];
