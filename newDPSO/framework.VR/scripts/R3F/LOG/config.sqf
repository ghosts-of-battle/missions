 ...
 * Si "side" : l'objet est verrouill? pour la derni?re side ayant interagit avec lui. (par d?faut)
 ...
 */
R3F_LOG_CFG_string_condition_allow_creation_factory_on_this_client = "player == leader (group player)";
