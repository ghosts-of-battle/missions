...
STR_R3F_LOG_action_ouvrir_usine = "Ouvrir l'usine de construction mobile";
STR_R3F_LOG_action_creer_en_cours = "Création en cours...";
STR_R3F_LOG_action_creer_fait = "L'objet ""%1"" a été créé.";
STR_R3F_LOG_action_creer_pas_assez_credits = "Vous ne disposez pas d'assez de crédits pour créer cet objet.";
