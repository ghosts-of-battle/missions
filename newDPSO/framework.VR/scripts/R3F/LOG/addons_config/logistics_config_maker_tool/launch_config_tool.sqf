 ...
 * @usage execVM "scripts\R3F\LOG\addons_config\logistics_config_maker_tool\launch_config_tool.sqf";
 * 
...
player addAction ["Dump config to RPT", "scripts\R3F\LOG\addons_config\logistics_config_maker_tool\dump_config.sqf"];
