...
// =========================================================================================================
	...
	private _randomPos = ["land", DPSO_mapCenter, 0, DPSO_mapRadius] call Gemini_fnc_findPos;
...
// =========================================================================================================
	...
	// SPAWNING SNIPER
	private _sniper = [DPSO_enemy_side1, grpNull, [DPSO_enemy_marksman], _overwatchPos, DPSO_enemy_AIskill, false, "task"] call Gemini_fnc_createUnit;
	...
	// SPAWNING SPOTTER
	private _spotter = [DPSO_enemy_side1, grpNull, [DPSO_enemy_rifleman], _overwatchPos, DPSO_enemy_AIskill, false, "task"] call Gemini_fnc_createUnit;
	...
	_sniper spawn
		{
			...
			while {(alive _sniper) && (DPSO_assignedTask)} do {sleep 3};
			if ((!alive _sniper) && (DPSO_assignedTask)) then {[] remoteExec ["Gemini_fnc_taskSucceeded"]; ['support', 'landAssistance'] call Gemini_fnc_bonus};
		};
