 ...
 *
 * Example:
 * [this, spawnPad] call DPSO_Mission_fnc_vehicleSpawnerair
 */
...
private _spawnAction = [
    ...
    {true},
    {
        ...
        private _allowedVehicles = [
            // "classname"
            "dpso_B_Heli_Transport_01_F_medic",
            "dpso_B_Heli_Transport_01_F_Sand",
            "dpso_B_Heli_Transport_01_F_Tropic",
            "dpso_B_Heli__03dazt_F",
            "dpso_B_Heli_Medevac_03daz_F",
            "dpso_B_Heli__03daz_F",
            "dpso_B_Heli_Medevac_03dazt_F",
            "dpso_B_Heli_Medevac_031_F",
            "B_Heli_Light_01_F",
