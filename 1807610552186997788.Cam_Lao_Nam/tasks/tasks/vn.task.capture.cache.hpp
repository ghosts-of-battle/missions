...
class VN_Task_Capture_Cache {
	...
	positionSearchTypes[] = {"Village","Town","Military"};
	positionIsWater = 0;
	...
	class TaskDetails {
		...
		description[] = {
			...
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>We have reports of a small %7 squad was observed near %5 moving what is beleived to be Weapons and Ammunition into the AO and would be great to capture.</t>"
	...
	class Groups {
		class weaponsCache_1 {
			probability = 1;
			isTarget = 1;
			objectTypes[] = {"Land_vn_us_weapons_stack1","Land_vn_us_weapons_stack2","Land_vn_us_weapons_stack3","Land_vn_us_weapons_stack4"};
