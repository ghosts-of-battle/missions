...
class CfgMissionTasks {
	// Task Objects
	intelDropTypes[] = {"Land_File1_F","Land_File2_F","Land_FilePhotos_F"};//,"Land_File1_F","Land_File2_F","Land_FilePhotos_F","Land_Map_F","Land_Notepad_F","Land_HandyCam_F","Land_MobilePhone_old_F","Land_MobilePhone_smart_F","Land_PortableLongRangeRadio_F","Land_File_research_F","Land_Tablet_01_F","Land_Tablet_02_F"};
	...
	WeaponCacheTypes[] = {"Box_FIA_Ammo_F","Box_FIA_Support_F","Box_FIA_Wps_F","Land_vn_us_weapons_stack1","Land_vn_us_weapons_stack2","Land_vn_us_weapons_stack3","Land_vn_us_weapons_stack4"};
	TowerTypes[] = {};
	SupplyTypes[] = {};
	...
	class PatrolOperations {
		...
		class ChildTasks {
			childtasks[] = {"VN_Task_Patrol_Area_1","VN_Task_Patrol_Area_2","VN_Task_Patrol_Area_3"};
		};
		class Objective {
			class Succeeded {
				state = 1;
	...
	#include "tasks\vn.task.capture.cache.hpp"
	#include "tasks\vn.task.clear.military.hpp"
	#include "tasks\vn.task.clear.radar.hpp"
	#include "tasks\vn.task.deploy.mines.hpp"
	#include "tasks\vn.task.deploy.tower.hpp"
	#include "tasks\vn.task.destroy.artillery.hpp"
	#include "tasks\vn.task.destroy.helipad.hpp"
	#include "tasks\vn.task.destroy.hvt.hpp"
	#include "tasks\vn.task.destroy.squad.hpp"
	#include "tasks\vn.task.destroy.vehicles.hpp"
	#include "tasks\vn.task.patrol.areas.hpp"
	#include "tasks\vn.task.recover.hvt.hpp"
	...
	#include "operations\vn.op.air.superiority.hpp"
	#include "operations\vn.op.rtf.commsnetwork.hpp"
	#include "operations\vn.op.sad.hvt.ins.hpp"
	#include "operations\vn.op.sad.weaponscache.hpp"
};