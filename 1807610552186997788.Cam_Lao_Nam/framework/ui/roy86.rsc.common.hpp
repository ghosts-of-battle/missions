...
class Rsc86ListNBox_Right: Rsc86Button {
	idc = 993;
	x = -1;
	y = -1;
...
class Rsc86ListNBox_Left: Rsc86ListNBox_RIGHT {
	idc = 992;
	text = "<";
};
...
class Rsc86Combo {
	...
	soundExpand[] = {"\A3\ui_f\data\sound\RscCombo\soundExpand",0.1,1};
	soundCollapse[] = {"\A3\ui_f\data\sound\RscCombo\soundCollapse",0.1,1};
	class ComboScrollBar: Rsc86ScrollBar {
		color[] = {1,1,1,1};
	};
};
...
class RscAmrelPDA: Rsc86PictureKeepAspect {
	...
	text = "framework\data\itemAmrelPDA\itemAmrelPDA_ca.paa";
};
...
class RscAmrelTablet: Rsc86PictureKeepAspect {
	...
	h = "25.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
	text = "framework\data\itemAmrelTablet\itemAmrelTablet_ca.paa";
};