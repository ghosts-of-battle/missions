...
/* Menu */
	case "onLoadMenu": {
		...
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc1","Tab 1: ForceTrack"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc2","Tab 2: Squads"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc3","Tab 3: Support"]] call MPSF_fnc_itemAmrelTablet;
		if ([player] call MPSF_fnc_isAdmin) then {
			["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc4","Tab 4: Operations"]] call MPSF_fnc_itemAmrelTablet;
		} else {
	...
	case "init" : {
		if (hasInterface) then {
			[] spawn {
				...
				// MPSF AMREL TABLET
				["MPSF_openAmrelTablet",player,"<t color='#ffC600'>Intel Documents</t>",{
					private _display = ([] call BIS_fnc_displayMission) createDisplay "RscDisplayAmrelTabletMenu";
				},[],"alive _target",true,false,100] spawn { sleep 0.2; _this call MPSF_fnc_addAction };
			};
		};
	};
/* Settings Menu */
	case "onLoadSettingsMenu" : {
		...
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc1","Tab 1: Empty"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc2","Tab 2: Empty"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc3","Tab 3: Empty"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc4","Tab 4: Empty"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc5","Tab 5: Empty"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc6","Tab 6: Empty"]] call MPSF_fnc_itemAmrelTablet;
