...
class CfgVirtualArmoury {
    enableFullArmoury = 0;
    allTraits[] = {"Crewman","PilotHeli","PilotPlane","Medic","Engineer","ExplosiveSpecialist","ExplosiveSpecialist"};
    allWeaponTypes[] = {
    ...
    /* ROLES */
    class INF {
        displayName = "Infantry"; //Name of the role, displayed in the respawn menu
    ...
    class HeavyINF {
        displayName = "Heavy Rifleman"; //Name of the role, displayed in the respawn menu
        icon = "a3\missions_f_exp\data\img\classes\assault_ca.paa"; //Icon shown next to the role name in the respawn screen
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist"};
    ...
    class AT {
        displayName = "AT"; //Name of the role, displayed in the respawn menu
        icon = "a3\missions_f_exp\data\img\classes\assault_ca.paa"; //Icon shown next to the role name in the respawn screen
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist"};
    ...
    class Spec {
        displayName = "Specialist"; //Name of the role, displayed in the respawn menu
        icon = "a3\missions_f_exp\data\img\classes\assault_ca.paa"; //Icon shown next to the role name in the respawn screen
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist","Engineer"};
        weaponTypes[] = {
            "AssaultRifle","Shotgun","Rifle","SubmachineGun","Handgun","Grenade","SmokeShell",
            "AccessoryMuzzle","AccessoryPointer","AccessorySights","AccessoryBipod","Uniform","Vest","Headgear",
            "Glasses","Binocular","Compass","FirstAidKit","Radio","Watch","Map",
    ...
    class TL {
        displayName = "Officer"; //Name of the role, displayed in the respawn menu
        icon = "a3\missions_f_exp\data\img\classes\assault_ca.paa"; //Icon shown next to the role name in the respawn screen
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist"};
    ...
    class Medic {
        ...
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist","Medic"};
        weaponTypes[] = {
            "AssaultRifle","Shotgun","Rifle","SubmachineGun","Handgun","Grenade","SmokeShell",
            "AccessoryMuzzle","AccessoryPointer","AccessorySights","AccessoryBipod","Uniform","Vest","Headgear",
            "Glasses","Binocular","Compass","FirstAidKit","Radio","Watch","Map",
    ...
    class Crewman {
        ...
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist","Crewman","Engineer","ExplosiveSpecialist"};
        weaponTypes[] = {
            "AssaultRifle","Shotgun","Rifle","SubmachineGun","Handgun","Grenade","SmokeShell",
            "AccessoryMuzzle","AccessoryPointer","AccessorySights","AccessoryBipod","Uniform","Vest","Headgear",
            "Glasses","Binocular","Compass","FirstAidKit","Radio","Watch","Map",
    ...
    class Pilot {
        displayName = "Pilot"; //Name of the role, displayed in the respawn menu
        icon = "a3\missions_f_exp\data\img\classes\assault_ca.paa"; //Icon shown next to the role name in the respawn screen
        limit = 0;
        fullArmoury = 0;
        traits[] = {"ExplosiveSpecialist","PilotHeli","PilotPlane","Engineer"};
        weaponTypes[] = {
