...
/* UI */
	case "onLoadForceTrackMenu" : {
		...
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc1","Tab 1: Overview"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc2","Tab 2: Edit Groups"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc3","Tab 3: Contact Reports"]] call MPSF_fnc_itemAmrelTablet;
