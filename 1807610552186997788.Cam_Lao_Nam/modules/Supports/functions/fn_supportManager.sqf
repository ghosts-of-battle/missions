...
/* Support Menu */
	case "onLoadSupportMenu" : {
		...
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc1","Tab 1: Artillery"]] call MPSF_fnc_itemAmrelTablet;
		...
		["switchControlGroup",["AmrelTabletSupportFiremission","RscDisplayAmrelTabletSupport",0]] call MPSF_fnc_itemAmrelTablet;
