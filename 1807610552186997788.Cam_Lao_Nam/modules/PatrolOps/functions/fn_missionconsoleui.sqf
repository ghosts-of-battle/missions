...
switch (_mode) do {
	case "onLoad" : {
		...
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc1","Tab 1: Intelligence"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc2","Tab 2: Available Ops"]] call MPSF_fnc_itemAmrelTablet;
		["setCtrlText",["RscControlAmrelTabletMenuScreen_Fnc3","Tab 3: Active Ops"]] call MPSF_fnc_itemAmrelTablet;
