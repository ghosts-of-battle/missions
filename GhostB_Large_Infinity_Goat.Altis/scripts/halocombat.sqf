...
_id = _this select 2;
_althalo = 300; //altitude of halo jump
...
if (not ("ACE_NonSteerableParachute" == typeOf (unitBackpack _caller))) 	exitwith {_caller groupchat "You will need a Non Steer able parachute to HALO.";};
