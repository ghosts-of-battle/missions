...
0 = [this, "INIT=", "[_proxyThis,] execVM 'scripts\re.sqf'] spawn jebus_fnc_main;
0 = [this, "PAUSE=", 100, "INIT=", "[_proxyThis, 'agia'] execVM 'UPS.sqf'"]
0 = [this, "INIT=", "[_proxyThis,] addEventHandler ["Fired",{(_this select 0) setVehicleAmmo 1}];"] spawn jebus_fnc_main;
