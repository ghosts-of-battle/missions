...
case (ch6+5):{if(r_vCH isEqualTo[FALSE,FALSE])then{3 enableChannel r_grCH;setCurrentChannel 3;}else{4 enableChannel r_vCH;setCurrentChannel 4;};};
case (ch7+5):{if(r_vCH isEqualTo[FALSE,FALSE])then{3 enableChannel r_grCH;setCurrentChannel 3;}else{4 enableChannel r_vCH;setCurrentChannel 4;};};
case (ch8+5):{if(r_vCH isEqualTo[FALSE,FALSE])then{3 enableChannel r_grCH;setCurrentChannel 3;}else{4 enableChannel r_vCH;setCurrentChannel 4;};};

case 2:{if(r_sCH isEqualTo[FALSE,FALSE])then{4 enableChannel r_vCH;setCurrentChannel 4;}else{
		...
		if(side player==EAST)then{if(channelEnabled ch7 isEqualTo[False,False])then{ch7 radioChannelAdd[player];};(ch7+5)enableChannel r_sCH;setCurrentChannel(ch7+5);};
		if(side player==INDEPENDENT)then{if(channelEnabled ch8 isEqualTo[False,False])then{ch8 radioChannelAdd[player];};(ch8+5)enableChannel r_sCH;setCurrentChannel(ch8+5);};}else{
		4 enableChannel r_vCH;setCurrentChannel 4;};}else{4 enableChannel r_vCH;setCurrentChannel 4;};};};};

case 3:{if(leader(group(vehicle player))==player)then{2 enableChannel r_cCH;setCurrentChannel 2;}else{
		if(player getUnitTrait"RTO")then{
		if(side player==WEST)then{if(channelEnabled ch6 isEqualTo[False,False])then{ch6 radioChannelAdd[player];};(ch6+5)enableChannel r_sCH;setCurrentChannel(ch6+5);};
		if(side player==EAST)then{if(channelEnabled ch7 isEqualTo[False,False])then{ch7 radioChannelAdd[player];};(ch7+5)enableChannel r_sCH;setCurrentChannel(ch7+5);};
		...
		}else{4 enableChannel r_vCH;setCurrentChannel 4;};};};

case 4:{if((r_grCH isEqualTo[FALSE,FALSE])&&(leader(group(vehicle player))==player))then{2 enableChannel r_cCH;setCurrentChannel 2;}else{
		if((r_grCH isEqualTo[FALSE,FALSE])&&(leader(group(vehicle player))!=player))then{3 enableChannel r_grCH;setCurrentChannel 3;}else{
		3 enableChannel r_grCH;setCurrentChannel 3;};};};

case 5:{if(r_vCH isEqualTo[FALSE,FALSE])then{3 enableChannel r_grCH;setCurrentChannel 3;}else{
