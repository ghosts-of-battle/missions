...
/*
Usage: In diver init insert: eg. null = [this, 25, 3000, 1.1, 0.15, 0.30, 0.55, 25] execVM "scripts\trindisplay\diverstats.sqf" 
	...
	while {alive _trinDiver && _psi >= 0 && player == _trinDiver} do
 {
	...
	if (underwater _trinDiver) then
			...
			*/
			...
			{
						case (_nTisTot <= 0): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_1.paa";					
						};	
						case ((_nTisTot > 0) && (_nTisTot <= 0.44)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_1.paa";					
						};
						case ((_nTisTot > 0.44) && (_nTisTot <= 0.66)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_2.paa";					
						};
						case ((_nTisTot > 0.66) && (_nTisTot <= 0.88)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_3.paa";					
						};
						case ((_nTisTot > 0.88) && (_nTisTot <= 1.1)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_4.paa";					
						};
						case ((_nTisTot > 1.1) && (_nTisTot <= 1.32)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_5.paa";					
						};
						case ((_nTisTot > 1.32) && (_nTisTot <= 1.54)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_6.paa";					
						};
						case ((_nTisTot > 1.54) && (_nTisTot <= 1.96)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_7.paa";					
						};
						case ((_nTisTot > 1.96) && (_nTisTot <= 2.15)): {					
						(_displayUI displayCtrl 1124) ctrlSetText "scripts\trindisplay\images\tis_8.paa";					
						};
			...
			{
					case (_dDepth > 0): {
						(_displayUI displayCtrl 1119) ctrlSetText "scripts\trindisplay\images\upArrow.paa";
						(_displayUI displayCtrl 1120) ctrlSetText "^";
						};
					case (_dDepth < 0): {
						(_displayUI displayCtrl 1119) ctrlSetText "scripts\trindisplay\images\downArrow.paa";
						(_displayUI displayCtrl 1120) ctrlSetText "v";						
						};
					case (_dDepth == 0): {
						(_displayUI displayCtrl 1119) ctrlSetText "scripts\trindisplay\images\noArrow.paa";
						(_displayUI displayCtrl 1120) ctrlSetText "";
			...
			if (_narcFactor > 8) then
				{
					...
					{
						null = ["true", "true", _trinDiver, (_narcFactor/50)] execVM "scripts\trindisplay\effects\trin_narcEffects.sqf";					
						_narcCntdn = 33;
					};					
				}
					else {
			...
			{	
				...
				{
					null = ["true", "true", _trinDiver] execVM "scripts\trindisplay\effects\trin_HeToxEffects.sqf";					
					_HeToxCntdn = 33;
				};				
			}
				else {
			...
			{	
				...
				{
					null = ["true", "true", _trinDiver, _O2DamMult] execVM "scripts\trindisplay\effects\trin_O2ToxEffects.sqf";					
					_O2ToxCntdn = 33;
				};
				playSound "trin_dispWarn";
			}
